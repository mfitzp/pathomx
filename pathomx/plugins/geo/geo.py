...
###### LOAD HANDLERS
    ...
    def load_soft_dataset(self, filename):  # Load from soft data file for genes
        ...
        dso.entities[1] = [db.dbm.get_via_synonym(gene_id, type='gene') for gene_id in dso.labels[1]]
    ...
    def load_soft_series_family(self, filename):  # Load from soft data file for genes
        ...
        dso.entities[1] = [db.dbm.get_via_unification('UNIGENE', gene_id) for gene_id in dso.labels[1]]
