...
class ImportAdvancedConfigPanel(ui.ConfigPanel):
    ...
    def __init__(self, parent, filename=None, *args, **kwargs):
        super(ImportAdvancedConfigPanel, self).__init__(parent, *args, **kwargs)
...
class ImportTextApp(ui.GenericTool):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.addConfigPanel(ImportTextConfigPanel, 'Settings')
        self.addConfigPanel(ImportAdvancedConfigPanel, 'Advanced')
